      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="flex gap-2">
            ...
            {selectedIds.length>0 && (<div>
                <Button variant="destructive" sixe="sm" onClick={handleBulkDelete}><Trash className="h-4 w-4 mr-2" />
                    Delete Selected({selectedIds.length})</Button>
                </div>
            )}

            {(searchTerm || typeFilter || recurringFilter)&& <Button variant="outline" sixe="icon" onClick={handleClearFilters} title="Clear Filters">
            ...
            {filteredAndSortedTransactions.length ===0?(
                ...
                filteredAndSortedTransactions.map((transaction)=>(
                    <TableRow key={transaction.id}>
                        ...
                        <TableCell className="text-right font-md" style={{
